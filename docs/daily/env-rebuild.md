# 重装系统千遍，环境重建难——关于「可重现开发环境」的折腾与思考
...
> [debian系、rh系系统重装脚本](../../resource/files/system-rebuild-shell.sh)    
...
## 三、尝试二：不可变系统的诱惑——Fedora Atomic 系
